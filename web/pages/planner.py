...
def create_planner_page():
    ...
    async def generate_planner():
        ...
        with ui.dialog() as loading_dialog, ui.card().classes("items-center p-8"):
            ...
            ui.label(_("Generating your planner...")).classes("text-lg mt-4").style(
                f"color: {COLORS['text']}"
            )
            ui.label(_("This may take a minute or two.")).classes("text-sm").style(
    ...
    with (
        ...
        with ui.element("div").classes("w-full max-w-4xl mx-auto"):
            ...
            with ui.element("div").classes("w-full text-center mb-8"):
                ...
                ui.label(_("Astrological Planner")).classes(
                    "font-display text-3xl md:text-4xl tracking-wide"
                ).style(f"color: {COLORS['text']}")
                ui.label(_("Generate a personalized PDF planner")).classes(
                    "text-base mt-2"
            ...
            with ui.column().classes("w-full gap-6"):
                ...
                with (
                    ...
                    ui.label(f"☆  {_('DATE RANGE')}").classes(
                    ...
                    with ui.column().classes("gap-4 w-full"):
                        ...
                        with ui.row().classes("items-center gap-4"):
                            ui.radio(
                                {"full": _("Full Year"), "custom": _("Custom Range")},
                                value="full",
                                on_change=lambda e: update_field(
                                    "use_custom_range", e.value == "custom"
                                ),
                            ).props("inline")

                        # Year selector (shown when not custom)
                        with ui.row().classes("items-center gap-4"):
                            ui.label(_("Year:")).classes("w-24").style(
                                f"color: {COLORS['text']}"
                            )
                            ui.number(
                                value=state.year,
                        ...
                        with ui.row().classes("items-center gap-4"):
                            ui.label(_("Start:")).classes("w-24").style(
                                f"color: {COLORS['text_muted']}"
                            )
                            ui.input(
                            ...
                            ui.label(_("End:")).classes("w-16 ml-4").style(
                                f"color: {COLORS['text_muted']}"
                            )
                            ui.input(
                ...
                with (
                    ...
                    ui.label(f"☆  {_('TIMEZONE')}").classes(
                        "font-display text-xs tracking-[0.2em] mb-4"
                    ).style(f"color: {COLORS['primary']}")

                    with ui.row().classes("items-center gap-4"):
                        ui.label(_("Timezone:")).classes("w-24").style(
                            f"color: {COLORS['text']}"
                        )
                        ui.select(
                    ...
                    ui.label(
                        _("All transit times will be displayed in this timezone.")
                ...
                with (
                    ...
                    ui.label(f"☆  {_('FRONT MATTER')}").classes(
                        "font-display text-xs tracking-[0.2em] mb-4"
                    ).style(f"color: {COLORS['primary']}")

                    ui.label(
                        _("Charts and reference pages at the start of your planner.")
                    ...
                    with ui.column().classes("gap-2"):
                        ...
                        ui.checkbox(
                            _("Profections (Lord of the Year)"),
                        ...
                        with ui.row().classes("items-center gap-2"):
                            ...
                            ui.select(
                                options={
                                    "Part of Fortune": _("Part of Fortune"),
                                    "Part of Spirit": _("Part of Spirit"),
                                },
                                value=state.zr_lot,
                ...
                with (
                    ...
                    ui.label(f"☆  {_('DAILY CONTENT')}").classes(
                        "font-display text-xs tracking-[0.2em] mb-4"
                    ).style(f"color: {COLORS['primary']}")

                    ui.label(_("What to include in your daily/weekly pages.")).classes(
                        "text-sm mb-4"
                    ).style(f"color: {COLORS['text_muted']}")
                    ...
                    with ui.column().classes("gap-2"):
                        ...
                        ui.checkbox(
                            _("Mundane Transits (planet-to-planet in sky)"),
                        ...
                        ui.checkbox(
                            _("Moon Phases (new, full, quarters)"),
                        ...
                        with ui.row().classes("items-center gap-2"):
                            ...
                            ui.select(
                                options={
                                    "traditional": _("Traditional (Sun-Saturn)"),
                                    "modern": _("Modern (includes outers)"),
                                },
                ...
                with (
                    ...
                    ui.label(f"☆  {_('PAGE LAYOUT')}").classes(
                        "font-display text-xs tracking-[0.2em] mb-4"
                    ).style(f"color: {COLORS['primary']}")

                    with ui.column().classes("gap-4"):
                        with ui.row().classes("items-center gap-4"):
                            ui.label(_("Page Size:")).classes("w-32").style(
                                f"color: {COLORS['text']}"
                            )
                            ui.select(
                                options={
                        ...
                        with ui.row().classes("items-center gap-4"):
                            ui.label(_("Week Starts On:")).classes("w-32").style(
                                f"color: {COLORS['text']}"
                            )
                            ui.select(
                                options={"sunday": _("Sunday"), "monday": _("Monday")},
                        ...
                        with ui.row().classes("items-center gap-4"):
                            ui.label(_("Binding Margin:")).classes("w-32").style(
                                f"color: {COLORS['text']}"
                            )
                            ui.number(
